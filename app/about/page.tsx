...
export default function About() {
    return (
        <div className="relative min-h-screen bg-linear-to-br from-amber-50 via-white to-green-50 overflow-x-hidden">
            ...
            {/* Vector Art - Bottom Right Corner (Medium priority) */}
            ...
            {/* Vector Art - Top Left Corner (Small accent) */}
            ...
            {/* Vector Art - Top Right Corner (Small accent) */}
